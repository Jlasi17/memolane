...
# Page Configuration
st.set_page_config(page_title="Suhrt - Your AI Friend", layout="centered")
st.markdown("<h1 style='text-align: center;'>Suhrt</h1>", unsafe_allow_html=True)
...
def detect_keyword_category(text):
    ...
    IDENTITY_PATTERNS = [r"\bwho are you\b",r"\what is your name\b", r"\bwho is Suhrt\b", r"\bwhat is Suhrt\b", r"\btell me about Suhrt\b"]
...
def get_direct_response(category):
    if category == "greeting":
        return random.choice([
            ...
            "Hey there! I'm Suhrt. How's your day going?",
...
def generate_response(user_input):
    ...
    with st.spinner("Suhrt is thinking..."):
        try:
            chatbot_response = llama_pipe(prompt, max_tokens=512, temperature=0.7)
